...
import 'reservation_status_model.dart';
export 'reservation_status_model.dart';
...
class _ReservationStatusWidgetState extends State<ReservationStatusWidget> {
  late ReservationStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservationStatusModel());
  }
